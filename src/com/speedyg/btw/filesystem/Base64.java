...
public class Base64 extends BaseNCodec {
    ...
    public Base64(int var1, byte[] var2, boolean var3) {
        ...
        if (var2 != null) {
            ...
            if (var1 > 0) {
                ...
                java.lang.System.arraycopy(var2, 0, this.lineSeparator, 0, var2.length);
            } else {
                this.encodeSize = 4;
    ...
    void encode(byte[] var1, int var2, int var3, Context var4) {
        if (!var4.eof) {
            if (var3 < 0) {
                var4.eof = true;
                ...
                if (this.lineLength > 0 && var4.currentLinePos > 0) {
                    java.lang.System.arraycopy(this.lineSeparator, 0, var5, var4.pos, this.lineSeparator.length);
                ...
                for (int var8 = 0; var8 < var3; ++var8) {
                    ...
                    if (0 == var4.modulus) {
                        ...
                        if (this.lineLength > 0 && this.lineLength <= var4.currentLinePos) {
                            java.lang.System.arraycopy(this.lineSeparator, 0, var9, var4.pos, this.lineSeparator.length);
                            var4.pos += this.lineSeparator.length;
    ...
    void decode(byte[] var1, int var2, int var3, Context var4) {
        if (!var4.eof) {
            if (var3 < 0) {
                var4.eof = true;
            }
    ...
    static byte[] toIntegerBytes(BigInteger var0) {
        ...
        if (var0.bitLength() % 8 != 0 && var0.bitLength() / 8 + 1 == var1 / 8) {
            ...
            java.lang.System.arraycopy(var2, var3, var6, var5, var4);
            return var6;
        }
    }
